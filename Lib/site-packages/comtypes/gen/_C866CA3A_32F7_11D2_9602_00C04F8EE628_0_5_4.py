...
__all__ = [
    'DISPID_SPEAudioStreamOffset', 'DISPID_SPRDisplayAttributes',
    'DISPID_SPIReplacements', 'SPPS_Verb', 'SVEWordBoundary',
    'SpCustomStream', 'DISPID_SRCRequestedUIType',
    'eLEXTYPE_PRIVATE20', 'eLEXTYPE_RESERVED6', 'SRTEmulated',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SVPause',
    'DISPID_SOTDataKey', 'DISPID_SAStatus', 'SP_VISEME_8',
    'ISpeechAudio', 'SPWF_SRENGINE', 'LONG_PTR',
    'SpeechAudioFormatType', 'SPGS_DISABLED',
    'ISpeechRecoResultTimes', 'SpeechRecoProfileProperties',
    '_SPAUDIOSTATE', 'SPSNoun', 'SASRun', 'SpeechRecognizerState',
    'SLTApp', 'SpeechGrammarRuleStateTransitionType', 'SVP_12',
    'DISPID_SpeechRecoResultTimes', 'SAFT11kHz16BitStereo',
    'DISPID_SRSClsidEngine', 'DISPID_SPAsCount',
    'DISPID_SDKDeleteValue', 'SPDKL_DefaultLocation',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPPS_Function',
    'DISPID_SAFGetWaveFormatEx', 'SAFT24kHz8BitMono',
    'SpStreamFormatConverter', 'DISPID_SRStatus',
    'SVESentenceBoundary', 'DISPID_SASCurrentDevicePosition',
    'SAFT22kHz16BitMono', 'SpeechWordType', 'SVF_Emphasis',
    'DISPID_SABIMinNotification', 'SPEVENT', 'SPSHORTCUTPAIRLIST',
    'SSFMCreateForWrite', 'SPXRO_Alternates_SML', 'SpObjectToken',
    'SDA_One_Trailing_Space', 'SRTExtendableParse', 'DISPID_SLWWord',
    'SGLexical', 'ISpeechLexiconWords', 'DISPID_SVEVoiceChange',
    'SPAS_STOP', 'DISPID_SGRsFindRule', 'SAFT32kHz16BitStereo',
    'SPEI_TTS_PRIVATE', 'DISPID_SRRAudio', 'SPDKL_CurrentConfig',
    'SPWORDLIST', 'DISPID_SpeechPhraseProperties', 'SGRSTTWildcard',
    'SpeechDisplayAttributes', 'ISpeechWaveFormatEx',
    'DISPID_SPELexicalForm', 'SPRULESTATE', 'DISPID_SASNonBlockingIO',
    'SRESoundEnd', 'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SECFIgnoreCase',
    'DISPID_SRSCurrentStreamNumber', 'ISpGrammarBuilder', 'SITooLoud',
    'SSTTTextBuffer', 'SAFTADPCM_11kHzStereo', 'SPLO_STATIC',
    'DISPID_SGRSTWeight', 'SpeechRunState', 'DISPID_SRSAudioStatus',
    'DISPID_SPIAudioSizeBytes',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'ISpEventSource',
    'SPBO_NONE', 'SPSHT_OTHER', 'SAFT24kHz8BitStereo',
    'eLEXTYPE_PRIVATE5', 'SAFT16kHz8BitStereo', 'SPEI_RESERVED6',
    'SPPS_Noun', 'SDTPronunciation', 'SPWORDPRONOUNCEABLE',
    'SAFTADPCM_22kHzStereo', 'SVP_20', 'SpeechVisemeType', 'SpStream',
    'SpeechSpecialTransitionType', 'SAFT22kHz8BitStereo',
    'DISPID_SRCERecognizerStateChange',
    'DISPID_SpeechPhraseAlternate', 'SPBOOKMARKOPTIONS',
    'ISpObjectToken', 'DISPID_SPPsItem', 'SVP_16',
    'STSF_LocalAppData', 'SpeechDataKeyLocation',
    'SPINTERFERENCE_NONE', 'ISpRecoContext2',
    'DISPID_SVSInputSentenceLength', 'SPAS_RUN',
    'DISPID_SRRSetTextFeedback', 'SpeechTokenShellFolder',
    'eLEXTYPE_PRIVATE3', 'DISPID_SLAddPronunciationByPhoneIds',
    'SRCS_Enabled', 'DISPID_SVSLastResult', 'DISPID_SRRTLength',
    'SPEI_SR_RETAINEDAUDIO', 'SAFTExtendedAudioFormat',
    'SpeechCategoryAudioIn', 'DISPID_SVGetAudioOutputs',
    'SPPROPERTYINFO', 'SPEI_WORD_BOUNDARY', 'ISequentialStream',
    'ISpPhrase', 'ISpeechPhraseRules', 'SVSFIsNotXML',
    'DISPID_SpeechPhraseRules', 'DISPID_SRAudioInput',
    'ISpeechRecoContext', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SVEWord', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SRSetPropertyNumber', 'SAFT48kHz8BitStereo',
    'SpeechBookmarkOptions', 'eLEXTYPE_PRIVATE13',
    'SPINTERFERENCE_TOOLOUD', 'SPAR_Medium', 'ISpeechGrammarRules',
    'DISPID_SGRAttributes', 'DISPID_SRGetFormat', 'SPPS_Interjection',
    'DISPID_SRCEPropertyStringChange', 'SpeechCategoryRecoProfiles',
    'ISpeechPhraseProperties', 'DISPID_SLGetGenerationChange',
    'STCLocalServer', 'ISpNotifySource', 'SpeechVoiceEvents',
    'DISPID_SMSGetData', 'SpeechPropertyLowConfidenceThreshold',
    'ISpeechResourceLoader', 'DISPID_SABufferInfo',
    'ISpeechPhoneConverter', 'SVSFParseSapi', 'SpeechInterference',
    'SLOStatic', 'SPDATAKEYLOCATION', 'SAFTADPCM_8kHzMono',
    'DISPID_SGRSTRule', 'DISPID_SPPParent', 'ISpeechRecoResult',
    'DISPID_SVSInputWordLength', 'SpeechWordPronounceable',
    'DISPID_SpeechRecognizerStatus', 'SAFTCCITT_uLaw_44kHzMono',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SpeechPhraseReplacements',
    'STCAll', 'SREBookmark', 'DISPID_SRCPause', 'SPPS_Unknown',
    'DISPID_SWFEChannels', 'DISPID_SRCEStartStream',
    'DISPID_SBSFormat', 'DISPID_SRGetRecognizers',
    'DISPID_SLWPronunciations', 'SDTProperty', 'SpFileStream',
    'eLEXTYPE_PRIVATE10', 'SpeechCategoryRecognizers',
    'DISPID_SLPsCount', 'ISpeechPhraseAlternate', 'DISPID_SGRId',
    'SECLowConfidence', 'SpPhraseInfoBuilder',
    'DISPID_SRCEventInterests', 'SAFT11kHz16BitMono',
    'SAFTCCITT_ALaw_8kHzStereo', 'SREStreamStart',
    'DISPID_SpeechPhraseAlternates', 'SAFTCCITT_uLaw_44kHzStereo',
    'SWPUnknownWordPronounceable',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SOTsItem',
    'ISpObjectTokenCategory', 'SPRECOGNIZERSTATUS',
    'SAFTCCITT_ALaw_22kHzStereo', 'tagSPPROPERTYINFO',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SpeechAudio', 'eLEXTYPE_PRIVATE19', 'DISPID_SGRAddState',
    'DISPID_SBSSeek', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SpeechAudioBufferInfo', 'DISPIDSPRG', 'SPSHT_EMAIL',
    'SDA_Consume_Leading_Spaces', 'SREAudioLevel',
    'DISPID_SVEStreamStart', 'DISPID_SRState', 'SVSFParseAutodetect',
    'DISPID_SOTCId', 'SREFalseRecognition', 'WAVEFORMATEX',
    'DISPID_SVSLastBookmark', 'SP_VISEME_13', 'SPVISEMES',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SRCVoicePurgeEvent', 'SP_VISEME_7', 'SRERecognition',
    'DISPID_SpeechGrammarRules', 'SpeechCategoryAudioOut',
    'DISPID_SOTId', 'ISpeechMemoryStream', 'SAFT48kHz16BitStereo',
    'SPSModifier', 'ISpStream', 'SVSFPurgeBeforeSpeak',
    'DISPID_SPIAudioStreamPosition', 'SPRST_INACTIVE', 'SPBO_AHEAD',
    'DISPID_SLWLangId', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SGRs_NewEnum', 'DISPID_SRCERequestUI', 'SGDisplay',
    'DISPID_SPARecoResult', 'DISPID_SPANumberOfElementsInResult',
    'SRSActive', 'DISPID_SVEStreamEnd', 'DISPID_SRGDictationSetState',
    'SpeechLoadOption', 'eLEXTYPE_PRIVATE14', 'ISpeechVoice',
    'SVEStartInputStream', 'DISPID_SPPEngineConfidence',
    'DISPID_SpeechLexicon', 'SPEI_RESERVED1', 'DISPID_SABIEventBias',
    'ISpeechAudioBufferInfo', 'SPGRAMMARWORDTYPE',
    'DISPID_SGRSAddWordTransition', 'SDTAlternates',
    'SDKLLocalMachine', 'SBOPause', 'SPINTERFERENCE_NOSIGNAL',
    'Speech_Max_Word_Length', 'SPPARTOFSPEECH', 'DISPID_SLWType',
    'DISPID_SVEPhoneme', 'DISPID_SRCRetainedAudio',
    'SPADAPTATIONRELEVANCE', 'DISPID_SpeechPhraseProperty',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SOTMatchesAttributes',
    'SRTAutopause', 'DISPID_SpeechPhoneConverter',
    'SDA_Two_Trailing_Spaces', 'SPEI_UNDEFINED',
    'SpUnCompressedLexicon', 'SDTRule', 'SPEI_START_SR_STREAM',
    'SGSDisabled', 'STCInprocHandler', 'ISpeechPhraseElements',
    'SpeechVisemeFeature', 'ISpAudio', 'SVSFlagsAsync', 'SGRSTTWord',
    'SpeechTokenContext', 'DISPID_SGRSTType', 'SAFTADPCM_8kHzStereo',
    'DISPID_SRGSetWordSequenceData', 'SpObjectTokenCategory',
    'DISPID_SPPs_NewEnum', 'ISpeechFileStream', 'SRTReSent',
    'SAFT22kHz8BitMono', 'SAFT12kHz16BitStereo',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SVEViseme',
    'SpeechRecognitionType', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SRCEFalseRecognition', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SDTAudio', 'SPPS_LMA', 'SITooQuiet', 'SPAR_Unknown',
    'DISPID_SpeechRecoContext', 'SPWF_INPUT', 'SVEAudioLevel',
    'SRSInactive', 'DISPID_SpeechDataKey', 'SPDKL_LocalMachine',
    'SpCompressedLexicon', 'SPEI_RESERVED2', 'SPCT_SLEEP',
    'DISPID_SRCState', 'SpeechPartOfSpeech', 'DISPID_SVGetProfiles',
    'SPPHRASEELEMENT', 'SPPS_RESERVED3', 'STSF_FlagCreate',
    'SPFM_NUM_MODES', 'SPPHRASE', 'SAFT32kHz8BitMono',
    'DISPID_SVEAudioLevel', 'DISPID_SRCEHypothesis',
    'SAFT24kHz16BitMono', 'SPSHORTCUTTYPE', 'DISPID_SRCEEndStream',
    'SpeechMicTraining', 'SWPUnknownWordUnpronounceable',
    'SECFEmulateResult', 'ISpeechObjectTokens', 'DISPID_SMSADeviceId',
    'DISPID_SLWs_NewEnum', 'DISPID_SPIAudioSizeTime',
    'SECHighConfidence', 'SREAllEvents', 'DISPID_SVEEnginePrivate',
    'SASStop', 'SpeechTokenKeyAttributes', 'DISPID_SOTIsUISupported',
    'SPTEXTSELECTIONINFO', 'DISPID_SVPriority', 'SP_VISEME_6',
    'SGPronounciation', 'DISPID_SOTRemoveStorageFileName',
    'SPFILEMODE', 'DISPID_SVSPhonemeId',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPEI_RESERVED5', 'SpeechEmulationCompareFlags',
    'SpeechAudioProperties', 'ISpObjectWithToken', 'SPRST_NUM_STATES',
    'SAFTADPCM_44kHzStereo', 'ISpeechXMLRecoResult',
    'DISPID_SRGCmdLoadFromObject', 'SRATopLevel', 'DISPID_SPRsItem',
    'SPRS_INACTIVE', 'DISPID_SPRuleConfidence', 'DISPID_SMSALineId',
    'DISPID_SGRInitialState', 'DISPID_SLRemovePronunciation',
    'SpeechFormatType', 'DISPID_SPRuleEngineConfidence',
    'SECNormalConfidence', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SVSLastBookmarkId', 'DISPID_SRGCmdSetRuleState',
    'SAFT24kHz16BitStereo', 'SPBINARYGRAMMAR', 'SPSHT_Unknown',
    'DISPID_SPRText', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SPEAudioTimeOffset', 'ISpRecoResult', 'DISPID_SRGReset',
    'SPSHORTCUTPAIR', 'SSTTDictation', 'SRTSMLTimeout', 'IStream',
    'SPEI_PHRASE_START', 'DISPID_SVEBookmark', 'SVEAllEvents',
    'SLODynamic', 'DISPID_SLWsCount', 'SGRSTTEpsilon',
    'SREInterference', 'DISPID_SpeechCustomStream', 'DISPID_SGRClear',
    'SP_VISEME_9', 'DISPID_SVSyncronousSpeakTimeout', 'SPXRO_SML',
    'DISPID_SRGCmdLoadFromResource', 'STSF_CommonAppData',
    'SAFTCCITT_uLaw_22kHzMono', 'SPSInterjection',
    'SPPHRASEREPLACEMENT', 'SPAR_High', 'SVSFPersistXML',
    'DISPID_SDKSetBinaryValue', 'eLEXTYPE_PRIVATE2',
    'SpeechAudioFormatGUIDWave', 'SPPHRASEPROPERTY',
    'SPEI_SR_BOOKMARK', 'DISPID_SPIRetainedSizeBytes',
    'SpInprocRecognizer', '_ISpeechRecoContextEvents', 'SVP_2',
    'SPCT_DICTATION', 'SPEI_MIN_SR', 'DISPID_SPPChildren',
    'SPVPRI_ALERT', 'SWPKnownWordPronounceable', 'SPWT_DISPLAY',
    'DISPID_SRCESoundStart', 'DISPID_SGRSTransitions',
    'DISPID_SRCEInterference', 'DISPID_SOTDisplayUI', 'SPLEXICONTYPE',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SPCLangId',
    'DISPID_SABufferNotifySize', 'DISPID_SMSAMMHandle',
    '__MIDL_IWinTypes_0009', 'DISPID_SPPConfidence',
    'DISPID_SPCPhoneToId', 'DISPID_SBSWrite', 'SP_VISEME_4',
    'DISPID_SPRs_NewEnum', 'DISPID_SMSSetData',
    'DISPID_SpeechAudioFormat', 'SPRST_ACTIVE_ALWAYS',
    'SPEI_SOUND_END', 'SREStateChange', 'DISPID_SASState', 'SPSVerb',
    'DISPID_SWFESamplesPerSec', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SpeechGrammarRule', 'DISPID_SGRSAddRuleTransition',
    'SVSFVoiceMask', 'SDA_No_Trailing_Space', 'SpeechLexiconType',
    'DISPID_SGRAddResource', 'DISPID_SGRSTsItem', 'SpMMAudioEnum',
    'SAFTCCITT_ALaw_11kHzMono', 'SP_VISEME_18', 'ISpDataKey',
    'DISPID_SPEsItem', 'SPWORDTYPE', 'DISPID_SRCEAudioLevel',
    'DISPID_SPEAudioSizeBytes', 'SAFT16kHz16BitStereo',
    'DISPID_SpeechXMLRecoResult', 'SPEI_RECO_OTHER_CONTEXT',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SVSpeak', 'SPVPRI_NORMAL',
    'SpeechRecoContextState', 'SPGS_ENABLED', 'SpeechRecoEvents',
    'DISPID_SVWaitUntilDone', 'DISPID_SpeechRecoResult2',
    'DISPID_SGRSTPropertyId', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SDKGetStringValue', 'DISPID_SRGDictationLoad',
    'DISPID_SpeechRecoResult', 'DISPID_SPIProperties',
    'DISPID_SPRFirstElement', 'DISPID_SVResume',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SRTStandard',
    'DISPID_SGRSTPropertyValue', 'SpPhoneticAlphabetConverter',
    'SPINTERFERENCE_NOISE', 'DISPID_SGRSTsCount',
    'DISPID_SVAudioOutputStream', 'SGDSActiveWithAutoPause',
    'SREPropertyStringChange', 'SAFT11kHz8BitStereo', 'SRAONone',
    'ISpPhraseAlt', 'DISPID_SRProfile', 'DISPID_SBSRead',
    'DISPID_SVESentenceBoundary', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SRRTOffsetFromStart', 'SAFTCCITT_uLaw_11kHzMono',
    'SVSFIsFilename', 'DISPID_SVIsUISupported',
    'SpeechTokenValueCLSID', 'DISPID_SpeechRecognizer',
    'SSTTWildcard', 'SpeechGrammarTagWildcard', 'SP_VISEME_5',
    'ISpeechLexicon', 'SPEVENTSOURCEINFO', 'SpeechTokenIdUserLexicon',
    'SREStreamEnd', 'DISPID_SpeechLexiconProns', 'SVEBookmark',
    'SpeechCategoryVoices', 'SPEI_MAX_SR', 'DISPID_SLGetWords',
    'eLEXTYPE_RESERVED4', 'SPXMLRESULTOPTIONS', 'eLEXTYPE_PRIVATE12',
    'SpeechEngineConfidence', 'DISPID_SWFEBitsPerSample',
    'eLEXTYPE_PRIVATE15', 'DISPID_SRGCmdLoadFromFile', 'SASPause',
    'SPPS_RESERVED2', 'ISpShortcut', 'DISPID_SPEDisplayText',
    'DISPID_SOTRemove', 'DISPID_SOTsCount', 'ISpRecognizer2',
    'SVEViseme', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SPERetainedSizeBytes', 'ISpRecognizer3',
    'SPSHT_NotOverriden', 'eLEXTYPE_PRIVATE11',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SGRSTText',
    'Speech_Default_Weight', 'DISPID_SPAs_NewEnum',
    'DISPID_SpeechPhraseInfo', 'DISPID_SRCResume', 'SFTSREngine',
    'ISpPhoneConverter', 'ISpeechObjectTokenCategory',
    'DISPID_SOTSetId', 'SPSERIALIZEDPHRASE', 'SAFT44kHz8BitMono',
    'SpeechEngineProperties', 'DISPID_SOTGetDescription',
    'DISPID_SPRuleId', 'SDTReplacement', 'DISPID_SVDisplayUI',
    'SLTUser', 'SGSExclusive', 'SDKLCurrentUser',
    'DISPID_SpeechMMSysAudio', 'SP_VISEME_0', 'STCInprocServer',
    'eLEXTYPE_PRIVATE18', 'DISPID_SVAudioOutput',
    'DISPID_SRGIsPronounceable', 'SINone', 'SVP_21', 'SPEI_RESERVED3',
    'DISPID_SREmulateRecognition', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SAFType', 'SAFTText',
    'SAFTADPCM_11kHzMono', 'DISPID_SRAudioInputStream',
    'DISPID_SOTs_NewEnum', 'SpeechVoiceSkipTypeSentence',
    'SpeechRuleState', 'ISpeechLexiconWord',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SVGetAudioInputs',
    'DISPID_SGRSRule', 'SPSMF_UPS', 'SPPHRASERULE',
    'DISPID_SPCIdToPhone', 'DISPID_SpeechFileStream',
    'DISPID_SRRSpeakAudio', 'SpPhoneConverter', 'SVP_7',
    'SSFMOpenForRead', 'ISpeechRecoResultDispatch',
    'SpeechTokenKeyFiles', 'SAFT44kHz8BitStereo', 'SpWaveFormatEx',
    'DISPID_SPIGetText', 'ISpRecognizer', 'ISpeechObjectToken',
    'DISPID_SpeechVoiceStatus', 'STCRemoteServer', 'DISPID_SPPName',
    'DISPID_SRIsShared', 'SPCATEGORYTYPE', 'DISPID_SOTCDefault',
    'SPEI_VISEME', 'SpLexicon', 'SDKLCurrentConfig',
    'SSSPTRelativeToEnd', 'ISpRecoContext', 'DISPID_SOTCGetDataKey',
    'ISpRecoGrammar', 'SVP_10', 'SPEI_VOICE_CHANGE',
    'eLEXTYPE_PRIVATE7', 'SVSFNLPSpeakPunc', 'SAFT8kHz16BitStereo',
    'SPFM_CREATE_ALWAYS', 'DISPID_SRCERecognitionForOtherContext',
    'SpeechPropertyResponseSpeed', 'SVSFNLPMask',
    'SAFT16kHz16BitMono', 'SpeechAddRemoveWord', 'SPVOICESTATUS',
    'DISPID_SRRRecoContext', 'eLEXTYPE_APP', 'SPPS_SuppressWord',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SRDisplayUI', 'ISpRecoGrammar2',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SRCRecognizer',
    'SP_VISEME_2', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SAEventHandle', 'SPAO_RETAIN_AUDIO',
    'DISPID_SPRulesCount', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SRGRules', 'eLEXTYPE_PRIVATE4', 'SAFT16kHz8BitMono',
    'DISPID_SpeechPhraseRule', 'eLEXTYPE_LETTERTOSOUND',
    'SPEI_MAX_TTS', 'DISPID_SRGState', 'DISPIDSPTSI',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SPIElements',
    'DISPID_SRRecognizer', 'SAFT48kHz8BitMono', 'SPSERIALIZEDRESULT',
    'SPSEMANTICFORMAT', 'SRSEIsSpeaking', 'DISPID_SRRGetXMLErrorInfo',
    'eLEXTYPE_PRIVATE1', 'SRSInactiveWithPurge', 'SRCS_Disabled',
    'DISPID_SLWsItem', 'DISPID_SRRPhraseInfo', 'SpAudioFormat',
    'SPINTERFERENCE_TOOQUIET', 'SRERecoOtherContext', 'SGSEnabled',
    'SVEEndInputStream', 'SPSFunction',
    'ISpeechGrammarRuleStateTransitions', 'SECFDefault',
    'SpMMAudioIn', 'SpeechDictationTopicSpelling',
    'eLEXTYPE_PRIVATE8', 'SAFT22kHz16BitStereo',
    'DISPID_SWFEFormatTag', 'DISPID_SVSInputSentencePosition',
    'SPCS_DISABLED', 'DISPID_SDKEnumKeys', 'SP_VISEME_3', 'UINT_PTR',
    'ISpeechAudioStatus', 'DISPID_SPEs_NewEnum',
    'DISPID_SGRSAddSpecialTransition',
    'SpeechRegistryLocalMachineRoot', 'SAFTNonStandardFormat',
    'ISpResourceManager', 'SPINTERFERENCE', 'ISpVoice',
    'SREAdaptation', 'DISPID_SpeechVoice', 'eLEXTYPE_RESERVED7',
    'DISPID_SRRAudioFormat', 'SPEI_SR_PRIVATE', 'SINoSignal',
    'DISPID_SOTCategory', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SPPValue', 'SAFTADPCM_44kHzMono', 'SPSSuppressWord',
    'SVP_5', 'SPINTERFERENCE_TOOFAST', 'ISpeechPhraseProperty',
    'DISPID_SDKDeleteKey', 'DISPID_SpeechPhraseElements',
    'SPPS_Modifier', 'SP_VISEME_15', '_RemotableHandle',
    'DISPID_SPACommit', 'SVP_6', 'SpNullPhoneConverter',
    'SPEI_PHONEME', 'DISPID_SCSBaseStream', 'SPBO_PAUSE',
    'DISPID_SADefaultFormat', 'SpSharedRecoContext', 'SVSFParseMask',
    'SpMMAudioOut', 'eLEXTYPE_RESERVED10', 'IInternetSecurityManager',
    'DISPID_SRRGetXMLResult', 'SpInProcRecoContext',
    'ISpeechMMSysAudio', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SRCESoundEnd',
    'SAFT48kHz16BitMono', 'DISPID_SVRate', 'DISPID_SPPFirstElement',
    'DISPID_SDKSetLongValue', 'SpeechDiscardType',
    'IEnumSpObjectTokens', 'DISPID_SRRTimes',
    'DISPID_SRRSaveToMemory', 'SSFMCreate', 'DISPID_SGRName',
    'SRSActiveAlways', 'DISPID_SASCurrentSeekPosition', 'SPAS_PAUSE',
    'SRADynamic', 'ISpeechRecoGrammar', 'tagSTATSTG',
    'SSFMOpenReadWrite', 'DISPID_SDKEnumValues',
    'SpeechRetainedAudioOptions', 'SPSTREAMFORMATTYPE',
    'SAFTCCITT_ALaw_22kHzMono', 'SP_VISEME_21',
    'SAFTGSM610_44kHzMono', 'eLEXTYPE_PRIVATE9',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SPEsCount',
    'Speech_StreamPos_Asap', 'DISPID_SPRuleName',
    'SPSMF_SAPI_PROPERTIES', 'eWORDTYPE_ADDED', 'DISPID_SPRulesItem',
    'SVF_None', 'SVSFUnusedFlags', 'eLEXTYPE_PRIVATE6', 'SPRULE',
    'SP_VISEME_1', 'SPAUDIOOPTIONS', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SVSkip', 'SPSNotOverriden', 'SPFM_CREATE', 'SVPAlert',
    'SPVPRIORITY', 'SPAR_Low', 'DISPID_SRCCmdMaxAlternates',
    'SPEI_MIN_TTS', 'DISPID_SRCCreateGrammar', 'DISPID_SPIEngineId',
    'SpResourceManager', 'SVSFParseSsml', 'DISPID_SRRTStreamTime',
    'DISPID_SRRDiscardResultInfo', 'SVP_9',
    'DISPID_SRSNumberOfActiveRules', 'SPPS_NotOverriden',
    'DISPID_SpeechGrammarRuleState', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SRRTTickCount', 'DISPID_SPPId', 'ISpeechPhraseElement',
    'SDTDisplayText',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SGRSTTDictation', 'SAFTGSM610_11kHzMono', 'SRSEDone',
    'Speech_Max_Pron_Length', 'SBONone', 'ISpMMSysAudio',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPRS_ACTIVE_USER_DELIMITED', 'ISpLexicon', 'SRAImport',
    'ISpeechDataKey', 'SpeechStreamSeekPositionType', 'SRESoundStart',
    'ISpNotifySink', 'SPEVENTENUM', 'SVP_8', 'SPEI_END_SR_STREAM',
    'ISpeechRecognizerStatus', 'DISPID_SRGetPropertyString',
    'SAFT32kHz8BitStereo', 'SAFTADPCM_22kHzMono',
    'DISPID_SVSRunningState', 'DISPID_SWFEBlockAlign', 'SITooFast',
    'SpeechGrammarTagDictation', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SPEPronunciation', 'SP_VISEME_16', 'DISPID_SGRsCount',
    'SPFM_OPEN_READONLY', 'DISPID_SPIGrammarId', 'ISpeechGrammarRule',
    'DISPID_SDKGetlongValue', 'SVP_18', 'DISPID_SRCEEnginePrivate',
    'SAFT8kHz8BitMono', 'DISPIDSPTSI_SelectionLength',
    'SpeechStreamFileMode', 'DISPID_SAFGuid', 'SPVPRI_OVER',
    'DISPID_SRCEAdaptation', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SPIStartTime', 'SECFIgnoreWidth', 'SpeechAudioVolume',
    'SPFM_OPEN_READWRITE', 'ISpSerializeState',
    'SPEI_RECO_STATE_CHANGE', 'SAFTDefault', 'DISPID_SGRsItem',
    'SDTLexicalForm', 'SpSharedRecognizer', 'SPEI_REQUEST_UI',
    'DISPID_SASFreeBufferSpace', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SPRuleChildren', 'DISPID_SWFEExtraData',
    'DISPID_SDKCreateKey',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRCSetAdaptationData', 'SPWAVEFORMATTYPE', 'SVP_4',
    'DISPID_SPERequiredConfidence', 'SPAS_CLOSED',
    'DISPID_SVSpeakStream', 'SPEI_INTERFERENCE',
    'ISpNotifyTranslator', 'DISPID_SPAsItem',
    'DISPID_SRGCmdSetRuleIdState', 'SAFTGSM610_8kHzMono',
    'SP_VISEME_20', 'DISPID_SPIRule', 'DISPID_SRCreateRecoContext',
    'SVP_0', 'eLEXTYPE_USER', 'SASClosed', 'DISPID_SASetState',
    'SGDSActive', 'ISpStreamFormatConverter',
    'SGDSActiveUserDelimited', 'SPSLMA', 'SREPropertyNumChange',
    'DISPID_SLPs_NewEnum', 'SpeechAudioState', 'SAFT8kHz8BitStereo',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SPILanguageId',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SVGetVoices',
    'SpeechAllElements', 'SECFNoSpecialChars', 'DISPID_SRCEBookmark',
    'SWTAdded', 'DISPID_SpeechObjectTokens', 'SPRS_ACTIVE',
    'DISPID_SRGId', 'SPSMF_SRGS_SAPIPROPERTIES',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SpeechAudioStatus',
    'SpeechRegistryUserRoot', 'SPEI_ADAPTATION',
    'SAFTCCITT_ALaw_44kHzMono', 'SPCT_COMMAND',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPWT_PRONUNCIATION', 'SVPOver',
    'DISPID_SRGSetTextSelection', 'SP_VISEME_12',
    'DISPID_SVSVisemeId', 'DISPID_SPPsCount',
    'DISPID_SRIsUISupported', 'ISpeechAudioFormat',
    'SPEI_SOUND_START', 'ISpeechPhraseAlternates', 'DISPID_SVVolume',
    'DISPID_SLPLangId', 'DISPID_SVStatus', 'SpVoice',
    'SPCT_SUB_COMMAND', 'eLEXTYPE_RESERVED9',
    'DISPID_SGRsCommitAndSave', 'ISpPhoneticAlphabetSelection',
    'SP_VISEME_17', 'SPCT_SUB_DICTATION', 'SVP_19',
    'DISPID_SGRsCommit', 'SAFT44kHz16BitMono',
    'SPWORDPRONUNCIATIONLIST', 'eLEXTYPE_RESERVED8',
    'DISPID_SpeechObjectTokenCategory', 'SpeechVoicePriority',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SFSOpen', 'SPPS_RESERVED4',
    'SP_VISEME_10', 'ISpeechCustomStream',
    'DISPID_SPPNumberOfElements', 'SPAUDIOSTATUS', 'SP_VISEME_19',
    'ISpeechPhraseInfo', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SLPPartOfSpeech', 'SVP_13', 'SRADefaultToActive',
    'eLEXTYPE_PRIVATE16', 'DISPID_SPEAudioSizeTime', 'SPWT_LEXICAL',
    'SpeechRuleAttributes', 'DISPID_SRCERecognition',
    'DISPID_SPIEnginePrivateData', 'SpeechGrammarState',
    'DISPID_SABIBufferSize', 'ISpeechGrammarRuleStateTransition',
    'DISPIDSPTSI_SelectionOffset', 'SVSFDefault', 'SPEI_TTS_BOOKMARK',
    'SECFIgnoreKanaType', 'DISPID_SRGRecoContext', 'SRERequestUI',
    'DISPID_SRCEPhraseStart', 'DISPID_SPEActualConfidence',
    'DISPID_SpeechVoiceEvent', 'SpeechTokenKeyUI',
    'SPEI_END_INPUT_STREAM', 'SPCS_ENABLED', 'DISPID_SPAPhraseInfo',
    'DISPID_SPEEngineConfidence', 'SRAInterpreter',
    'SpeechVoiceSpeakFlags',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SRARoot',
    'SAFTCCITT_ALaw_11kHzStereo', 'SAFTCCITT_ALaw_44kHzStereo',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SRCVoice',
    'DISPID_SFSClose', 'eLEXTYPE_PRIVATE17', 'SPPS_Noncontent',
    'SAFTGSM610_22kHzMono', 'DISPID_SpeechRecoContextEvents',
    'SAFT8kHz16BitMono', 'DISPID_SPRules_NewEnum',
    'DISPID_SLPPhoneIds', 'SVF_Stressed', 'SGRSTTTextBuffer',
    'SAFT12kHz16BitMono', 'DISPID_SOTGetAttribute', 'SGRSTTRule',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SAVolume',
    'DISPID_SGRSTNextState', 'ISpEventSink', 'DISPID_SLGenerationId',
    'SPRECOSTATE', 'SVPNormal', 'DISPID_SGRsDynamic',
    'ISpeechBaseStream', 'SPLOADOPTIONS', 'SPRECOCONTEXTSTATUS',
    'SPAUDIOBUFFERINFO', 'DISPID_SLAddPronunciation', 'SPRST_ACTIVE',
    'DISPID_SLPType', 'SRAExport', 'SAFT12kHz8BitStereo',
    'ISpeechVoiceStatus', 'DISPID_SRGetPropertyNumber',
    'DISPID_SLGetPronunciations', 'SAFT11kHz8BitMono',
    'ISpPhoneticAlphabetConverter', 'DISPID_SDKGetBinaryValue',
    'SpeechCategoryAppLexicons', 'IInternetSecurityMgrSite',
    'SREPrivate', 'DISPID_SPAStartElementInResult', 'SVP_1',
    'SpTextSelectionInformation', 'eWORDTYPE_DELETED',
    'ISpeechPhraseReplacements', 'SAFT12kHz8BitMono',
    'DISPID_SPRuleFirstElement', 'SPEI_RECOGNITION',
    'DISPID_SVEventInterests', 'STSF_AppData',
    'SpeechPropertyNormalConfidenceThreshold',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpeechRecoResult2',
    'DISPID_SPRsCount', 'DISPID_SpeechLexiconWords',
    'DISPID_SDKOpenKey', 'DISPID_SGRSTPropertyName',
    '_ISpeechVoiceEvents', 'DISPID_SpeechLexiconWord',
    'DISPID_SpeechPhraseElement', 'SFTInput', 'SPGS_EXCLUSIVE',
    'ISpeechGrammarRuleState', 'SP_VISEME_14', 'SWTDeleted',
    'ISpeechLexiconPronunciation', 'ISpeechRecognizer',
    'SPWORDPRONUNCIATION', 'DISPID_SRRAlternates', 'SpShortcut',
    'ISpeechPhraseInfoBuilder', 'SRAORetainAudio', 'ISpXMLRecoResult',
    'ISpeechPhraseReplacement', 'SPEI_HYPOTHESIS', 'IEnumString',
    'ISpeechLexiconPronunciations', 'DISPID_SRCBookmark',
    'SPBO_TIME_UNITS', 'SAFTNoAssignedFormat', 'SpeechUserTraining',
    'SPCONTEXTSTATE', 'SVEVoiceChange', 'SDKLDefaultLocation',
    'SPWORD', 'DISPID_SRGCommit', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SRCAudioInInterferenceStatus', 'SVEPhoneme', 'SVP_3',
    'SVP_15', 'DISPID_SLPSymbolic', 'ISpProperties', 'SPGRAMMARSTATE',
    'SVSFIsXML', 'SDTAll', 'SVP_14', 'DISPID_SPEDisplayAttributes',
    'SPSUnknown', 'SPDKL_CurrentUser', 'SPPS_RESERVED1',
    'DISPID_SGRSTs_NewEnum', 'ISpRecoCategory', 'DISPID_SOTCSetId',
    'DISPID_SpeechBaseStream', 'SSSPTRelativeToStart',
    'SPEI_START_INPUT_STREAM', 'DISPID_SLPsItem',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SPRNumberOfElements',
    'SpeechAudioFormatGUIDText', 'SGLexicalNoSpecialChars',
    'ISpeechTextSelectionInformation', 'SpeechPropertyAdaptationOn',
    'SPRECORESULTTIMES', 'SPSEMANTICERRORINFO',
    'DISPID_SVAlertBoundary', 'DISPID_SOTCreateInstance', 'SVP_17',
    'SPLO_DYNAMIC', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SpeechObjectToken', 'SpeechGrammarWordType', 'SVP_11',
    'DISPID_SRGDictationUnload', 'SAFT44kHz16BitStereo',
    'SREHypothesis', 'SGDSInactive', 'SpeechPropertyResourceUsage',
    'DISPID_SVSInputWordPosition', 'SpeechCategoryPhoneConverters',
    'DISPID_SOTGetStorageFileName', 'DISPID_SpeechMemoryStream',
    'SAFT32kHz16BitMono', 'SpNotifyTranslator',
    'DISPID_SRSSupportedLanguages', 'DISPID_SGRsAdd',
    'ISpStreamFormat', 'SVEPrivate', 'SPAUDIOSTATE',
    'Speech_StreamPos_RealTime', 'DISPID_SDKSetStringValue',
    'DISPID_SPISaveToMemory', 'SP_VISEME_11', 'ISpeechPhraseRule',
    'SpMemoryStream', 'SINoise', 'SPAO_NONE',
    'DISPID_SRSetPropertyString', 'DISPID_SVVoice',
    'DISPID_SPRuleParent', 'SREPhraseStart', 'tagSPTEXTSELECTIONINFO',
    'eLEXTYPE_VENDORLEXICON', 'SITooSlow'
]

_check_version('1.1.14', 1646384666.480055)
