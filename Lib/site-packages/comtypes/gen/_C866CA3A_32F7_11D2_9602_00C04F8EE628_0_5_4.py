...
__all__ = [
    'SGRSTTWildcard', 'DISPID_SVSkip', 'SPPHRASEELEMENT',
    'SAFT22kHz8BitStereo', 'SpeechVoiceSkipTypeSentence',
    'SpeechCategoryAudioIn', 'DISPID_SPIRule', 'DISPID_SVSpeakStream',
    'STCLocalServer', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SPVPRI_OVER', 'SAFT24kHz8BitMono', 'DISPID_SOTDataKey',
    'SAFTNonStandardFormat', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SPERetainedSizeBytes', 'SAFTCCITT_ALaw_11kHzStereo',
    'SpeechVoiceEvents', 'SpCustomStream', 'SpMemoryStream',
    'SPEI_SR_BOOKMARK', 'DISPID_SDKGetStringValue', 'SVSFIsXML',
    'DISPID_SpeechObjectTokens', 'SGLexicalNoSpecialChars',
    'DISPID_SRCSetAdaptationData', 'SPWORDTYPE', 'SpeechTokenKeyUI',
    'SPSNoun', 'ISpeechPhraseProperties', 'DISPID_SOTCDefault',
    'SVEEndInputStream', 'DISPID_SpeechAudio', 'SPINTERFERENCE',
    'DISPID_SpeechFileStream', 'DISPID_SRCEPropertyNumberChange',
    'SAFT16kHz8BitMono', 'ISpNotifyTranslator',
    'SPINTERFERENCE_LATENCY_WARNING', 'SP_VISEME_8',
    'SpeechTokenShellFolder', 'SREPrivate', 'SLTApp',
    'SREPropertyStringChange', 'DISPID_SVVolume',
    'ISpeechPhraseRules', 'SPPHRASEPROPERTY', 'DISPID_SOTCSetId',
    'DISPID_SPRNumberOfElements', 'SPGS_ENABLED',
    'SPWORDPRONUNCIATION', 'ISpeechAudio', 'SAFTCCITT_uLaw_44kHzMono',
    'ISpeechRecognizer', 'SRSActive', 'DISPID_SLGetGenerationChange',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SASFreeBufferSpace',
    'DISPID_SLWPronunciations', 'SpInProcRecoContext',
    'SPEI_RESERVED1', 'DISPID_SGRSTWeight', 'DISPID_SPEDisplayText',
    'SAFT16kHz16BitMono', 'ISpeechRecoResultDispatch',
    'DISPID_SAFType', 'SPWORDPRONUNCIATIONLIST', 'SRSEIsSpeaking',
    'eLEXTYPE_PRIVATE9', 'DISPID_SLGetWords', 'SPPS_LMA',
    'DISPID_SRCVoice', 'DISPID_SRCRetainedAudioFormat',
    'SAFTADPCM_22kHzStereo', 'SPEI_PHONEME', 'DISPID_SRRecognizer',
    'SAFT8kHz16BitMono', 'DISPID_SFSOpen', 'DISPID_SRGCommit',
    'DISPID_SOTs_NewEnum', 'SREStreamEnd', 'DISPID_SGRsDynamic',
    'SPSModifier', 'DISPID_SOTIsUISupported', '_ISpeechVoiceEvents',
    'SAFTGSM610_8kHzMono', 'SPDKL_LocalMachine',
    'SpeechAudioProperties', 'DISPID_SAStatus', 'SPEI_VISEME',
    'ISpPhoneConverter', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SRSClsidEngine', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SPRuleId', 'DISPID_SRRAudioFormat', 'DISPID_SVPriority',
    'IEnumString', 'DISPID_SRCEPhraseStart', 'DISPID_SRCRecognizer',
    'SRCS_Enabled', 'DISPID_SPAPhraseInfo', 'SVP_3',
    'SpSharedRecognizer', 'DISPID_SPRulesItem',
    'SDA_Two_Trailing_Spaces', 'SAFTGSM610_44kHzMono',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SABufferInfo',
    'DISPID_SASCurrentDevicePosition', 'SpeechEngineConfidence',
    'DISPID_SAEventHandle', 'SPBO_AHEAD', 'DISPID_SRDisplayUI',
    'SP_VISEME_19', 'DISPID_SAVolume', 'ISpProperties', 'DISPIDSPRG',
    'ISpRecoGrammar', 'DISPID_SRProfile', 'DISPID_SVEPhoneme',
    'DISPID_SVGetAudioInputs', 'DISPID_SPRuleChildren', 'SRAExport',
    'SPEI_TTS_AUDIO_LEVEL', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SDKGetBinaryValue', 'SAFTADPCM_44kHzMono', 'SDTAll',
    'DISPID_SMSADeviceId', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SpeechAllElements', 'DISPID_SLWType',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SRCCreateGrammar',
    'DISPID_SPARecoResult', 'DISPID_SpeechLexiconWord',
    'eLEXTYPE_RESERVED8', 'ISpeechPhraseProperty',
    'DISPID_SLGetPronunciations', 'DISPID_SASNonBlockingIO',
    'DISPID_SVSpeakCompleteEvent', 'SLOStatic', 'ISpRecoResult',
    'SPAR_Low', 'DISPID_SPPName', 'SPCS_DISABLED',
    'SpeechDisplayAttributes', 'SpeechVoicePriority',
    'SREStreamStart', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SBSRead', 'DISPID_SRCResume',
    'DISPID_SVAudioOutputStream', 'eLEXTYPE_MORPHOLOGY',
    'SpeechAudioVolume', 'SRESoundEnd', 'ISpeechAudioFormat',
    'ISpeechGrammarRule', 'SDTDisplayText', 'SVP_19',
    'eLEXTYPE_RESERVED9', 'ISpPhoneticAlphabetSelection', 'SDTRule',
    'SBONone', 'DISPID_SRCEFalseRecognition',
    '_ISpeechRecoContextEvents', 'SPSHORTCUTTYPE',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SRGCmdSetRuleState', 'SPAS_RUN', 'DISPID_SPIGetText',
    'SP_VISEME_21', 'DISPID_SRCEInterference', 'SPRECORESULTTIMES',
    'DISPID_SpeechAudioStatus', 'DISPID_SGRClear', 'SVP_2', 'SpVoice',
    'eLEXTYPE_RESERVED4', 'SAFT12kHz8BitStereo', 'eLEXTYPE_RESERVED6',
    '__MIDL_IWinTypes_0009', 'STCInprocHandler', 'SpInprocRecognizer',
    'DISPID_SPILanguageId', 'eLEXTYPE_PRIVATE14',
    'DISPID_SpeechGrammarRules', 'SpeechCategoryAudioOut',
    'DISPID_SVSInputSentencePosition', 'SDKLCurrentUser',
    'DISPID_SPIProperties', 'SpeechRuleState', 'DISPID_SPPChildren',
    'SWTAdded', 'ISpeechPhraseReplacement', 'SpeechTokenKeyFiles',
    'SAFTCCITT_uLaw_22kHzStereo', 'SpeechVisemeType',
    'ISpeechRecoResultTimes', 'SVPNormal', 'SRESoundStart',
    'eLEXTYPE_PRIVATE2', 'DISPID_SVWaitUntilDone',
    'DISPID_SVSVisemeId', 'SpResourceManager',
    'DISPID_SRSSupportedLanguages', 'DISPID_SGRSAddWordTransition',
    'DISPID_SRState', 'DISPID_SOTCId', 'SPEI_MIN_SR',
    'SPINTERFERENCE_NONE', 'SITooFast', 'SPEI_PROPERTY_STRING_CHANGE',
    'SPAR_Medium', 'SGPronounciation', 'DISPID_SPAsCount',
    'DISPID_SCSBaseStream', 'SVP_9', 'ISpeechLexiconWord',
    'DISPID_SRRSaveToMemory', 'SDKLCurrentConfig',
    'SPEI_PHRASE_START', 'DISPID_SGRSTPropertyId',
    'SAFT22kHz8BitMono', 'DISPID_SRStatus', 'ISpeechGrammarRuleState',
    'SPPS_Verb', 'SPVISEMES', 'SVP_21', 'SSFMCreateForWrite',
    'DISPID_SLAddPronunciation', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SRGState', 'SGRSTTEpsilon', 'DISPID_SPIStartTime',
    'SAFT22kHz16BitMono', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SPIGetDisplayAttributes', 'SRERecognition',
    'DISPID_SBSSeek', 'IStream', 'SpeechBookmarkOptions',
    'SSSPTRelativeToCurrentPosition', 'SAFT11kHz8BitMono',
    'Speech_StreamPos_Asap', 'DISPID_SRRSetTextFeedback',
    'STSF_AppData', 'DISPID_SGRsCount', 'SpeechDataKeyLocation',
    'SP_VISEME_20', 'eLEXTYPE_PRIVATE17',
    'DISPID_SRRTOffsetFromStart', 'SPRS_ACTIVE',
    'SpeechDictationTopicSpelling', 'DISPID_SRCEAdaptation',
    'DISPID_SpeechLexicon', 'DISPID_SpeechAudioFormat',
    'SPSHORTCUTPAIRLIST', 'SRADynamic', 'ISpeechPhraseElements',
    'DISPID_SWFEExtraData', 'SpeechGrammarState',
    'SpeechSpecialTransitionType', 'DISPID_SLPPartOfSpeech',
    'DISPID_SpeechLexiconWords', 'SpeechStreamSeekPositionType',
    'DISPID_SRGCmdLoadFromResource', 'SAFT48kHz8BitStereo',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'ISpeechLexiconWords',
    'DISPID_SpeechPhoneConverter', 'DISPID_SAFGuid',
    'DISPID_SOTSetId', 'SVF_None', 'SVSFUnusedFlags',
    'SPPS_Noncontent', 'DISPID_SLPsCount', 'SVSFDefault',
    'DISPID_SVSLastResult', 'SVPAlert', 'SP_VISEME_18',
    'SREAudioLevel', 'SpeechPropertyResourceUsage',
    'DISPID_SPRuleName', 'SSTTTextBuffer', 'SVP_5',
    'SPADAPTATIONRELEVANCE', 'DISPID_SVEWord', 'SVSFVoiceMask',
    'DISPID_SPRules_NewEnum', 'SPEI_REQUEST_UI', 'SRSActiveAlways',
    'DISPID_SRRDiscardResultInfo', 'SPPS_RESERVED3', 'SPRULE',
    'DISPID_SPRDisplayAttributes', 'SPBO_PAUSE', 'SVEPrivate',
    'DISPID_SRGRecoContext', 'ISpeechMemoryStream',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SABufferNotifySize',
    'DISPID_SpeechRecognizer', 'DISPID_SpeechMemoryStream',
    'ISpRecoContext2', 'eLEXTYPE_PRIVATE13',
    'DISPID_SRGCmdSetRuleIdState', 'SECLowConfidence',
    'DISPID_SADefaultFormat', 'DISPID_SRGetPropertyString',
    'SVSFlagsAsync', 'SGDisplay', 'DISPID_SVSInputWordPosition',
    'SDTAlternates', 'DISPID_SGRSTsItem', 'DISPID_SBSFormat',
    'eLEXTYPE_PRIVATE19', 'ISpeechWaveFormatEx',
    'DISPID_SPERequiredConfidence', 'SAFT32kHz16BitStereo',
    'SPSHT_OTHER', 'DISPID_SpeechAudioBufferInfo', 'ISpeechLexicon',
    'DISPID_SPEAudioStreamOffset', 'SPCONTEXTSTATE', 'SREHypothesis',
    'SPPS_RESERVED4', 'DISPID_SRSetPropertyString',
    'DISPID_SRCCreateResultFromMemory', 'eLEXTYPE_LETTERTOSOUND',
    'SAFT22kHz16BitStereo', 'SAFTADPCM_11kHzMono',
    'DISPID_SOTDisplayUI', 'SECNormalConfidence',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SRSNumberOfActiveRules', 'SPINTERFERENCE_NOISE',
    'DISPID_SRRAlternates', 'SFTSREngine',
    'SAFTCCITT_uLaw_44kHzStereo', 'eLEXTYPE_PRIVATE8',
    'DISPID_SGRSAddRuleTransition', 'Speech_Max_Pron_Length',
    'DISPID_SPAs_NewEnum', 'ISpeechLexiconPronunciation',
    'DISPID_SDKCreateKey', 'SPEI_HYPOTHESIS', 'DISPID_SPEsCount',
    'DISPID_SOTCEnumerateTokens', 'SSSPTRelativeToStart',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'ISpeechVoiceStatus',
    'DISPID_SVGetProfiles', 'SVP_11', 'SPGRAMMARSTATE',
    'DISPID_SRGSetTextSelection', 'ISpeechXMLRecoResult',
    'DISPID_SOTId', 'SPEI_TTS_BOOKMARK', 'eLEXTYPE_PRIVATE7',
    'DISPID_SRGetRecognizers', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SDKEnumKeys', 'DISPID_SVEventInterests',
    'DISPID_SMSGetData', 'DISPID_SASState', 'SPPS_Unknown',
    'DISPID_SPEs_NewEnum', 'SpeechGrammarTagUnlimitedDictation',
    'SECHighConfidence', 'STSF_CommonAppData',
    'SpeechEngineProperties', 'SpeechRecognitionType',
    'DISPID_SRCERequestUI', 'SVPOver', 'ISpeechRecognizerStatus',
    'SVSFNLPSpeakPunc', 'ISpEventSink', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SGRSAddSpecialTransition', 'SpNotifyTranslator',
    'DISPID_SOTRemove', 'SPLO_DYNAMIC', 'SPAUDIOBUFFERINFO',
    'SpeechTokenContext', 'DISPID_SRAudioInputStream',
    'DISPID_SpeechPhraseInfo', 'ISpeechFileStream', 'SITooSlow',
    'SAFTCCITT_ALaw_8kHzStereo', 'ISpeechPhraseRule', 'SVF_Stressed',
    'DISPID_SLPs_NewEnum', 'SpeechAudioFormatGUIDText',
    'SAFT32kHz8BitStereo', 'SRTEmulated',
    'SpeechPropertyAdaptationOn', 'SLTUser', 'DISPID_SGRsAdd',
    'SGDSActiveUserDelimited', 'SPEI_SOUND_START', 'SVP_13',
    'ISpeechPhoneConverter', 'SPAR_High', 'ISpObjectWithToken',
    'SWPUnknownWordPronounceable', 'DISPID_SRGReset',
    'ISpeechTextSelectionInformation', 'SPEI_RECO_STATE_CHANGE',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SPIRetainedSizeBytes', 'IEnumSpObjectTokens',
    'DISPID_SOTGetAttribute', 'SpeechLexiconType', 'DISPID_SRCPause',
    'DISPID_SPPValue', 'SVESentenceBoundary',
    'SpeechTokenIdUserLexicon', 'DISPID_SPIElements',
    'DISPID_SPIGrammarId', 'SASRun', 'SPCT_SLEEP',
    'SDA_Consume_Leading_Spaces', 'SPAUDIOOPTIONS', 'DISPID_SLPsItem',
    'SAFTCCITT_ALaw_44kHzMono', 'SGRSTTRule', 'SPEI_MAX_SR',
    'SPEI_ADAPTATION', 'SPEI_SR_PRIVATE', 'ISpVoice',
    'DISPID_SRCAudioInInterferenceStatus', 'SpeechInterference',
    'ISpGrammarBuilder', 'ISpeechRecoGrammar',
    'DISPID_SGRSTPropertyValue', 'DISPID_SMSSetData',
    'DISPID_SVEViseme', 'eLEXTYPE_PRIVATE12', 'SRSInactiveWithPurge',
    'SAFTADPCM_8kHzMono', 'DISPID_SVESentenceBoundary',
    'SPEI_END_SR_STREAM', 'DISPID_SGRSTs_NewEnum', 'SPPS_Noun',
    'SSFMOpenReadWrite', 'SPEI_UNDEFINED', 'DISPID_SRRTStreamTime',
    'SAFTNoAssignedFormat', 'SpeechStreamFileMode',
    'DISPID_SVEAudioLevel', 'SRATopLevel', 'SpeechTokenValueCLSID',
    'DISPID_SRRTLength', 'DISPID_SWFESamplesPerSec', 'SPWF_SRENGINE',
    'DISPID_SPIEnginePrivateData', 'SPSInterjection',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPFM_OPEN_READONLY',
    'SDKLDefaultLocation', 'SAFT16kHz16BitStereo',
    'ISpeechRecoResult2', 'SPWF_INPUT', 'SPPS_NotOverriden',
    'SECFIgnoreWidth', 'SP_VISEME_4', 'SpeechCategoryAppLexicons',
    'DISPID_SVEVoiceChange', 'SPINTERFERENCE_TOOLOUD',
    'SPEI_RECO_OTHER_CONTEXT', 'SVP_7', 'DISPID_SRCERecognition',
    'SPCT_DICTATION', 'SVSFParseAutodetect', 'SpeechRecognizerState',
    'SPEI_RECOGNITION', 'SpeechVoiceCategoryTTSRate',
    'SpeechGrammarTagDictation', 'SSTTWildcard', 'SECFIgnoreKanaType',
    'DISPID_SRGRules', 'DISPID_SRAudioInput', 'DISPID_SRCEEndStream',
    'DISPID_SRGIsPronounceable', 'DISPIDSPTSI_SelectionLength',
    'SREAdaptation', 'DISPID_SPCPhoneToId', 'ISpeechDataKey',
    'SECFIgnoreCase', 'DISPID_SVIsUISupported',
    'DISPID_SVSRunningState', 'DISPID_SpeechVoiceEvent',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SPRulesCount',
    'SAFT48kHz16BitMono', 'UINT_PTR', 'SPWORDPRONOUNCEABLE',
    'DISPID_SPRuleConfidence', 'DISPID_SRRAudio',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SPEPronunciation', 'SPEI_END_INPUT_STREAM',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SVEEnginePrivate',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SREmulateRecognition',
    'ISpeechObjectTokenCategory',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'ISpLexicon',
    'DISPID_SRCEStartStream', 'SPPARTOFSPEECH', 'ISpRecognizer',
    'DISPID_SOTMatchesAttributes', 'SPSHT_Unknown', 'DISPID_SRCState',
    'SASStop', 'SpeechAudioState', 'DISPID_SGRSTransitions',
    'DISPID_SLWs_NewEnum', 'SFTInput', 'DISPID_SPEDisplayAttributes',
    'SPEI_START_SR_STREAM', 'SAFT32kHz8BitMono',
    'DISPID_SWFEAvgBytesPerSec', 'SPAS_STOP', 'SRAONone',
    'DISPID_SPRuleParent', 'DISPID_SVSPhonemeId', 'SPPS_RESERVED2',
    'SVSFParseMask', 'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'ISpeechVoice',
    'DISPID_SRGDictationLoad', 'SRSInactive',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SAFT24kHz8BitStereo',
    'SPPS_Interjection', 'SAFT44kHz16BitStereo', 'DISPID_SGRSTsCount',
    'SECFNoSpecialChars', 'SpNullPhoneConverter', 'ISpRecoGrammar2',
    'DISPID_SpeechPhraseRules', 'DISPID_SVSInputSentenceLength',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SRCRequestedUIType',
    'SPGS_DISABLED', 'DISPID_SGRSTType', 'DISPID_SpeechObjectToken',
    'SPINTERFERENCE_NOSIGNAL', 'SpStream', 'SRTStandard',
    'SGSDisabled', 'SLODynamic', 'DISPID_SGRName', 'SP_VISEME_13',
    'SpeechCategoryRecognizers', 'SINone', 'DISPID_SpeechRecoContext',
    'ISpeechObjectTokens', 'DISPID_SDKGetlongValue',
    'SAFT16kHz8BitStereo', 'DISPID_SVSpeak', 'DISPID_SLWsCount',
    'DISPID_SRRPhraseInfo', 'ISpeechObjectToken',
    'DISPID_SpeechGrammarRule', 'DISPID_SVAudioOutput', 'SGDSActive',
    'DISPID_SFSClose', 'DISPID_SRCreateRecoContext', 'SPXRO_SML',
    'SpeechRecoContextState', 'SSTTDictation', 'DISPID_SVResume',
    'DISPID_SWFEChannels', 'SPEI_RESERVED6', 'DISPID_SPRsItem',
    'ISpRecognizer3', 'ISpeechCustomStream', 'SVP_8',
    'DISPID_SVSInputWordLength', 'SpUnCompressedLexicon',
    'SPAS_PAUSE', 'SP_VISEME_10', 'SREPhraseStart', 'SpShortcut',
    'SPEI_RESERVED3', 'SITooLoud', 'SpMMAudioOut', 'SPLO_STATIC',
    'SPEVENTSOURCEINFO', 'SBOPause', 'SVSFPersistXML',
    'DISPID_SpeechCustomStream', 'SPRECOGNIZERSTATUS',
    'DISPID_SpeechPhraseReplacements',
    'DISPID_SRCEPropertyStringChange', 'SpeechRunState',
    'SpeechDiscardType', 'SAFTTrueSpeech_8kHz1BitMono', 'SVP_20',
    'ISpeechBaseStream', 'SPDKL_CurrentUser', 'DISPID_SLPType',
    'SPLOADOPTIONS', 'SPLEXICONTYPE', 'SPCT_SUB_DICTATION',
    'DISPID_SPPParent', 'ISpStreamFormatConverter',
    'SpPhoneConverter', 'ISpPhraseAlt', 'DISPIDSPTSI_ActiveLength',
    'SPWT_LEXICAL', 'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SRGId',
    'SAFT44kHz8BitStereo', 'DISPIDSPTSI_ActiveOffset',
    'eLEXTYPE_PRIVATE1', 'eLEXTYPE_USER', 'DISPID_SGRs_NewEnum',
    'SP_VISEME_14', 'eLEXTYPE_PRIVATE4', 'ISpRecognizer2',
    'DISPID_SRSCurrentStreamPosition',
    'DISPID_SpeechRecoContextEvents',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'IInternetSecurityMgrSite', 'SAFT44kHz8BitMono', 'SP_VISEME_1',
    'SDTAudio', 'SpPhoneticAlphabetConverter', 'SPBO_NONE',
    'SGLexical', 'SVEStartInputStream', 'SREStateChange',
    'DISPID_SpeechPhraseElements', 'SAFTCCITT_ALaw_44kHzStereo',
    'SRTReSent', 'ISpeechAudioBufferInfo', 'DISPID_SPELexicalForm',
    'SPSHT_EMAIL', 'DISPID_SVGetVoices', 'DISPID_SPPEngineConfidence',
    'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRSCurrentStreamNumber', 'SPRST_ACTIVE',
    'DISPID_SMSAMMHandle', 'STCAll', 'SPINTERFERENCE_TOOSLOW',
    'ISpeechPhraseReplacements', 'SPPHRASE', 'SPPHRASERULE',
    'DISPID_SRCEEnginePrivate', 'DISPID_SRCEventInterests',
    'DISPID_SRCESoundStart', 'SWPKnownWordPronounceable', 'SASPause',
    'DISPID_SOTGetStorageFileName', 'DISPID_SLRemovePronunciation',
    'SpMMAudioEnum', 'eLEXTYPE_RESERVED7', 'SREInterference',
    'SGRSTTTextBuffer', 'ISpMMSysAudio', 'SDTLexicalForm',
    'DISPID_SPPNumberOfElements', 'DISPID_SpeechVoiceStatus',
    'IInternetSecurityManager', 'ISpPhoneticAlphabetConverter',
    'SP_VISEME_7', 'SpeechAudioFormatType', 'SVEAllEvents',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SGRInitialState',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SpeechMMSysAudio',
    'SPEI_FALSE_RECOGNITION', 'SAFT12kHz16BitStereo',
    'DISPID_SDKOpenKey', 'DISPID_SBSWrite',
    'DISPID_SRSetPropertyNumber', 'SAFTADPCM_11kHzStereo',
    'SpSharedRecoContext', 'SPPHRASEREPLACEMENT', 'DISPID_SASetState',
    'DISPID_SABIBufferSize', 'SAFTExtendedAudioFormat',
    'DISPID_SpeechGrammarRuleState', 'SPCS_ENABLED',
    'eLEXTYPE_PRIVATE15', 'SVP_4', 'SPRECOCONTEXTSTATUS',
    'SpeechCategoryVoices', 'SpeechPropertyHighConfidenceThreshold',
    'ISpRecoCategory', 'SPSTREAMFORMATTYPE', 'SAFT48kHz16BitStereo',
    'DISPID_SLWLangId', 'SP_VISEME_0', 'SPGRAMMARWORDTYPE',
    'SpeechGrammarRuleStateTransitionType', 'SPEI_SENTENCE_BOUNDARY',
    'SAFT32kHz16BitMono', 'ISpeechAudioStatus', 'DISPID_SGRAddState',
    'SRCS_Disabled', 'DISPID_SABIMinNotification',
    'DISPID_SWFEBlockAlign', 'SPTEXTSELECTIONINFO',
    'SRERecoOtherContext', 'DISPID_SPPFirstElement',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SVEBookmark',
    'DISPID_SDKSetBinaryValue', 'SPPS_RESERVED1',
    'DISPID_SLPSymbolic', 'SSFMOpenForRead', 'Speech_Default_Weight',
    'SPAO_RETAIN_AUDIO', 'DISPID_SGRAttributes',
    'DISPID_SGRsFindRule', 'SAFT48kHz8BitMono', 'SAFT8kHz16BitStereo',
    'DISPID_SOTCGetDataKey', 'SECFEmulateResult', 'SPAUDIOSTATUS',
    'eLEXTYPE_PRIVATE16', 'DISPID_SRGDictationSetState',
    'SVSFNLPMask', 'SpeechAddRemoveWord', 'SPEVENTENUM',
    'SPRECOSTATE', 'DISPID_SPPBRestorePhraseFromMemory', 'SVP_6',
    'DISPID_SPRFirstElement', 'STSF_FlagCreate', 'eLEXTYPE_PRIVATE10',
    'SP_VISEME_3', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SpeechPhraseAlternate', 'SPSHT_NotOverriden',
    'DISPID_SRCVoicePurgeEvent', 'SITooQuiet', 'DISPIDSPTSI',
    'DISPID_SOTsItem', 'DISPID_SpeechBaseStream',
    'DISPID_SDKSetStringValue', 'DISPID_SRCERecognizerStateChange',
    'SPSVerb', 'SpeechVoiceSpeakFlags',
    'ISpeechGrammarRuleStateTransitions', 'eLEXTYPE_PRIVATE3',
    'SpeechRegistryLocalMachineRoot', 'SpObjectToken',
    'DISPID_SAFGetWaveFormatEx', 'SPSHORTCUTPAIR', 'SPVPRI_NORMAL',
    'SVSFParseSapi', 'ISpeechPhraseInfo', 'DISPID_SPRText',
    'SPFM_NUM_MODES', 'SpeechCategoryPhoneConverters', 'SECFDefault',
    'ISpShortcut', 'SpMMAudioIn', 'DISPID_SRCRetainedAudio',
    'SAFT8kHz8BitStereo', 'DISPID_SRCEHypothesis',
    'DISPID_SpeechWaveFormatEx', 'SpeechWordType', 'SRARoot',
    'SpeechRegistryUserRoot', 'SpeechMicTraining',
    'SAFTGSM610_22kHzMono', 'SPPS_Function', 'SPVPRI_ALERT',
    'SpeechRetainedAudioOptions', 'DISPID_SPAStartElementInResult',
    'DISPID_SLWWord', 'SpeechVisemeFeature', 'DISPID_SPIReplacements',
    'DISPID_SABIEventBias', 'DISPID_SVGetAudioOutputs', 'SPRULESTATE',
    'DISPID_SVAlertBoundary', 'SRTExtendableParse',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SGRAddResource',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SRRGetXMLResult',
    'ISequentialStream', 'SP_VISEME_16', 'DISPID_SRCESoundEnd',
    'DISPID_SPRuleFirstElement', 'SPEI_WORD_BOUNDARY',
    'Speech_Max_Word_Length', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SpeechVoice', 'ISpeechGrammarRules', 'SAFT8kHz8BitMono',
    'SAFT24kHz16BitMono', 'SpPhraseInfoBuilder', 'SGSEnabled',
    'DISPID_SPISaveToMemory', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SpeechXMLRecoResult', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SRRRecoContext', 'SpeechLoadOption', 'SPRST_INACTIVE',
    'ISpAudio', 'SPAUDIOSTATE', 'DISPID_SVSLastBookmark',
    'DISPID_SGRsCommit', 'ISpResourceManager', 'DISPID_SPPsCount',
    'SSFMCreate', 'SPEI_SOUND_END', 'ISpObjectToken',
    'DISPID_SRCEAudioLevel', 'SREPropertyNumChange',
    'ISpXMLRecoResult', 'SPEI_VOICE_CHANGE', 'DISPID_SVEStreamStart',
    'DISPID_SpeechDataKey', 'SVF_Emphasis', 'SPSEMANTICFORMAT',
    'DISPID_SRCEBookmark', 'SpeechPropertyResponseSpeed',
    'SpWaveFormatEx', 'DISPID_SpeechPhraseRule', 'SDTReplacement',
    'DISPID_SRSAudioStatus', 'SDA_No_Trailing_Space',
    'SPEI_RESERVED2', 'SP_VISEME_11', 'DISPID_SPCIdToPhone',
    'DISPID_SPPConfidence', 'SRAImport', 'ISpRecoContext',
    'SpeechPartOfSpeech', 'SPFM_CREATE', 'SINoSignal',
    'SSSPTRelativeToEnd', 'SVP_18', 'SPDKL_DefaultLocation',
    'SPSERIALIZEDPHRASE', 'SpAudioFormat', 'SPPS_Modifier',
    'SDA_One_Trailing_Space', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SRSEDone', 'DISPID_SVEStreamEnd', 'DISPID_SGRsItem',
    'SPVOICESTATUS', 'SPEI_MIN_TTS', 'DISPID_SRCBookmark',
    'ISpEventSource', 'SP_VISEME_5', 'DISPID_SLPPhoneIds',
    'DISPID_SDKSetLongValue', 'SVP_12', 'SPGS_EXCLUSIVE',
    'ISpObjectTokenCategory', 'DISPID_SPRsCount', 'ISpeechRecoResult',
    'SRERequestUI', 'SPWORD', 'eLEXTYPE_PRIVATE6', 'ISpDataKey',
    'DISPID_SGRSTPropertyName', 'SVP_10', 'SREAllEvents',
    'SPRS_INACTIVE', 'DISPID_SVSLastBookmarkId', 'STCRemoteServer',
    'STCInprocServer', 'DISPID_SPEAudioSizeBytes',
    'ISpeechMMSysAudio', 'SPFM_OPEN_READWRITE', 'DISPID_SOTsCount',
    'SAFTCCITT_uLaw_22kHzMono',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SpeechRecoResult', 'SGDSInactive', 'DISPID_SPCLangId',
    'SPEI_RESERVED5', 'SPPROPERTYINFO', 'SVP_0',
    'DISPID_SPIAudioSizeBytes', 'SRAInterpreter',
    'SpeechEmulationCompareFlags', 'DISPID_SLPLangId',
    'DISPID_SRGetFormat', 'SVSFParseSsml', 'DISPID_SPIAudioSizeTime',
    'SVEPhoneme', 'SP_VISEME_9', 'DISPID_SPRs_NewEnum',
    'SpStreamFormatConverter', 'SAFT12kHz16BitMono',
    'DISPID_SGRSTText', 'DISPID_SWFEBitsPerSample',
    'ISpeechLexiconPronunciations', 'DISPID_SRRSpeakAudio',
    'SAFT11kHz8BitStereo', 'DISPID_SLGenerationId',
    'SPWAVEFORMATTYPE', 'tagSTATSTG', 'SPXMLRESULTOPTIONS',
    'ISpeechPhraseInfoBuilder', 'SpeechGrammarTagWildcard',
    'DISPID_SLWsItem', 'DISPID_SWFEFormatTag', 'DISPID_SRRTTickCount',
    'ISpeechPhraseAlternate', 'SVP_1', '_RemotableHandle',
    'DISPID_SPIEngineId', 'ISpStream', 'SRTSMLTimeout',
    'DISPID_SpeechRecoResult2', 'SPPS_SuppressWord', 'SPAR_Unknown',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SOTGetDescription',
    'DISPID_SPPs_NewEnum', 'DISPID_SGRSTNextState',
    'SWPUnknownWordUnpronounceable', 'SpeechGrammarWordType',
    'SAFTCCITT_ALaw_22kHzMono', 'SPFILEMODE',
    ...
    'SAFT11kHz16BitMono', 'SRTAutopause', 'SPVPRIORITY',
    'DISPID_SOTCreateInstance', 'ISpSerializeState',
    'SpeechCategoryRecoProfiles', 'SPSFunction',
    'SREFalseRecognition', 'SAFTADPCM_8kHzStereo',
    'SAFT12kHz8BitMono', 'SpCompressedLexicon', 'DISPID_SPEsItem',
    'SPEI_INTERFERENCE',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'LONG_PTR',
    'SPSSuppressWord', 'SpFileStream', 'SPDKL_CurrentConfig',
    'DISPID_SPEAudioTimeOffset', 'SpLexicon', 'SAFT24kHz16BitStereo',
    'DISPID_SPEEngineConfidence', 'SPWORDLIST', 'SVEVoiceChange',
    'eWORDTYPE_DELETED', 'SpeechRecoProfileProperties',
    'SVEWordBoundary', 'SP_VISEME_2', 'ISpNotifySink', 'DISPID_SGRId',
    'eLEXTYPE_PRIVATE20', 'DISPID_SPPsItem', 'DISPID_SDKDeleteKey',
    'DISPID_SMSALineId', 'SPEI_TTS_PRIVATE', 'ISpeechResourceLoader',
    'SAFTDefault', 'SRADefaultToActive', 'DISPID_SPAsItem',
    'SVSFIsNotXML', 'DISPID_SpeechPhraseElement', 'SPWT_DISPLAY',
    'SVP_15', 'SAFTCCITT_ALaw_22kHzStereo', 'SP_VISEME_17',
    'SRAORetainAudio', 'SP_VISEME_15', 'SPBO_TIME_UNITS',
    'SPFM_CREATE_ALWAYS', 'eLEXTYPE_VENDORLEXICON',
    'SDTPronunciation', 'DISPID_SAFSetWaveFormatEx', 'eLEXTYPE_APP',
    'DISPID_SGRSRule', 'SVEViseme', 'SVP_16',
    'SGDSActiveWithAutoPause', 'SDTProperty',
    'SPINTERFERENCE_TOOQUIET', 'SVSFIsFilename', 'DISPID_SRRTimes',
    'SPEVENT', 'SpeechFormatType', 'DISPID_SOTRemoveStorageFileName',
    'ISpPhrase', 'DISPID_SpeechRecognizerStatus',
    'SpeechAudioFormatGUIDWave', 'DISPID_SDKEnumValues',
    '_SPAUDIOSTATE', 'DISPID_SPEAudioSizeTime', 'SAFTADPCM_22kHzMono',
    'DISPID_SRIsShared', 'SVP_14', 'DISPID_SVVoice',
    'SPSNotOverriden', 'DISPID_SpeechLexiconProns', 'eWORDTYPE_ADDED',
    'SPAO_NONE', 'SpeechRecoEvents', 'SASClosed', 'DISPID_SVStatus',
    'DISPID_SPIAudioStreamPosition', 'SP_VISEME_12', 'SINoise',
    'SAFTADPCM_44kHzStereo', 'SPCT_COMMAND', 'STSF_LocalAppData',
    'SDKLLocalMachine', 'DISPID_SDKDeleteValue', 'DISPID_SPPId',
    'DISPID_SPRuleEngineConfidence', 'SAFT11kHz16BitStereo',
    'SPCATEGORYTYPE', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SGRsCommitAndSave', 'DISPID_SRIsUISupported',
    'DISPID_SRCERecognitionForOtherContext', 'eLEXTYPE_PRIVATE5',
    'SPDATAKEYLOCATION', 'DISPID_SGRSTRule',
    'DISPID_SPERetainedStreamOffset', 'SPSUnknown',
    'SpeechUserTraining', 'SVEBookmark', 'Speech_StreamPos_RealTime',
    'ISpeechPhraseElement', 'DISPID_SOTCategory',
    'eLEXTYPE_RESERVED10', 'DISPID_SRRGetXMLErrorInfo', 'SAFTText',
    'SAFTCCITT_uLaw_8kHzStereo', 'SVSFPurgeBeforeSpeak',
    'SPSERIALIZEDRESULT', 'SPRST_ACTIVE_ALWAYS', 'SPSMF_UPS',
    'SVP_17', 'ISpeechGrammarRuleStateTransition', 'WAVEFORMATEX',
    'DISPID_SPEActualConfidence', 'ISpNotifySource', 'SVEAudioLevel',
    'DISPID_SpeechPhraseProperties', 'ISpeechRecoContext',
    'DISPID_SRGetPropertyNumber', 'DISPID_SVRate',
    'DISPID_SpeechPhraseAlternates', 'SGRSTTDictation',
    'eLEXTYPE_PRIVATE11', 'SPSLMA', 'SPWT_PRONUNCIATION',
    'tagSPPROPERTYINFO', 'SPBOOKMARKOPTIONS',
    'SpeechTokenKeyAttributes', 'SpObjectTokenCategory',
    'SPEI_SR_AUDIO_LEVEL', 'SP_VISEME_6', 'SPSEMANTICERRORINFO',
    'DISPID_SPRuleNumberOfElements', 'SAFTCCITT_uLaw_11kHzMono',
    'SGRSTTWord', 'SPEI_MAX_TTS', 'SPAS_CLOSED',
    'SpTextSelectionInformation', 'SREBookmark', 'DISPID_SVDisplayUI',
    'SPCT_SUB_COMMAND', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SRGCmdLoadFromFile', 'SPBINARYGRAMMAR',
    'DISPID_SPACommit', 'ISpStreamFormat', 'SAFT44kHz16BitMono',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SVPause',
    'DISPID_SpeechPhraseProperty', 'SPXRO_Alternates_SML',
    'eLEXTYPE_PRIVATE18', 'SWTDeleted', 'SpeechRuleAttributes',
    'SPRST_NUM_STATES', 'DISPID_SRGDictationUnload'
]

_check_version('1.1.14', 1697435530.387147)
